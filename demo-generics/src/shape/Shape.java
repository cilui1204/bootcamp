...
public abstract class Shape {
  ...
  public static void main(String[] args){
    ...
    System.out.println(Shape.area(shapes)); //80.4561878584346
    System.out.println(Shape.area2(shapes)); //80.4561878584346
    ...
    // shapes2.add(new Square(3.4)); /// NOT OK, during compile-time, we do not know the actual type of object reference by shape2
    ...
    shapes3.add(new Square(4.0));
    //shapes3.add(new Bird()); // NOT OK? Still have chance to be Shape array List

    // during compile time , we dont know actual type of shapes3
