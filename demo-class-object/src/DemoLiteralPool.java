public class DemoLiteralPool {
  ...
  public static void main(String[] args){
    ...
    s3=s4;
    System.out.println(s3==s4); //true, they are appointed to the same object
    ...
    s7 += "world";
    System.out.println(System.identityHashCode(s7));//146589023 (new String Object)
    ...
    //Same idea apply to most of the String methods;
    //concat(), substring()
