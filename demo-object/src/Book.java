...
//public class Book entends Object{
public class Book { //implicitly inherit Object.class
  private String author;
  private LocalDate publishDate;
  
  public Book(String arthor, LocalDate publishDate){
    this.author=arthor;
  ...
  // if you do not @Override, the hashCode() method by Default representing the object referene
  @Override
  public int hashCode(){
    return Objects.hash(this.author, this.publishDate);
  }

  // if you override it, the purpose is to make it become true even if they are 2 different object in heap memory
  @Override
  public boolean equals(Object obj){
    if (this==obj){
      return true;
    }
    if (!(obj instanceof Book)){ //"instanceof" is the object pointing by reference is an object produced by Book.class
      return false;
    }
    Book book = (Book) obj; //
  ...
  public static void main(String[] args){
    ...
    System.out.println(System.identityHashCode(b1)); //1933863327 , because b1 and b2 are duffernt objects
    ...
    System.out.println(b1.equals(new Cat())); //false, if you do not override
